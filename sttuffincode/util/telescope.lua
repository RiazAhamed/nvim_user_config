---@class stuffincode.util.telescope.opts
---@field cwd? string|boolean
---@field show_untracked? boolean

---@class stuffincode.util.telescope
...
-- cwd will default to .stuffincode.util.get_root
-- for `files`, git_files or find_files will be chosen depending on .git
---@param builtin string
---@param opts? stuffincode.util.telescope.opts
